      ...
      <div class="row mb-2 ml-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">
            {{ $value['loc'] }} {{ $updateterakhir['hari'] }} {{ $updateterakhir['tanggal'] }} Jam {{ $updateterakhir['jam'] }}
          </h1>
        </div>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="h5 mb-0 font-weight-bold text-gray-800" id="temp_in1">{{ $value['t'] }} ºC</div>
                </div>
                <div class="col-auto">
        ...
        <div class="col-md-4">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="h5 mb-0 font-weight-bold text-gray-800" id="hum_in1">{{ $value['h'] }} %</div>
                </div>
                <div class="col-auto">
        ...
        <div class="col-md-4">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="h5 mb-0 font-weight-bold text-gray-800" id="hum_in1">{{ $value['ws'] }} m/s</div>
                </div>
                <div class="col-auto">
        ...
        <div class="col-md-4">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="h5 mb-0 font-weight-bold text-gray-800" id="hum_in1">{{ $value['wc'] }}</div>
                </div>
                <div class="col-auto">
        ...
        <div class="col-md-4">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="h5 mb-0 font-weight-bold text-gray-800" id="hum_in1">DATA TIDAK DITEMUKAN</div>
                </div>
                <div class="col-auto">
